...
public class TrainingModel implements Serializable {
    ...
    public String ConStoreNametent;
    public String ApprovalStatus;
    public String ApplicationCreateTime;
    public String ApprovalIDList;

    public List<TrainingModel.ApprovalInfoLists> ApprovalInfoLists ;
    ...
    public List<TrainingModel.ApprovalInfoLists> getApprovalInfoLists() {
        return ApprovalInfoLists;
    }

    public void setApprovalInfoLists(List<TrainingModel.ApprovalInfoLists> approvalInfoLists) {
    ...
    public String getConStoreNametent() {
        return ConStoreNametent;
    }

    public void setConStoreNametent(String conStoreNametent) {
        ConStoreNametent = conStoreNametent;
    }
