...
public class BeawayModel implements Serializable {
    ...
    public List<BeawayModel.ApprovalInfoLists> getApprovalInfoLists() {
        return ApprovalInfoLists;
    }

    public void setApprovalInfoLists(List<BeawayModel.ApprovalInfoLists> approvalInfoLists) {
