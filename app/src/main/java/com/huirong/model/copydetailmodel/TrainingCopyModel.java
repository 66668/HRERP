...
public class TrainingCopyModel implements Serializable {
    ...
    public List<TrainingCopyModel.ApprovalInfoLists> ApprovalInfoLists ;
    ...
    public List<TrainingCopyModel.ApprovalInfoLists> getApprovalInfoLists() {
        return ApprovalInfoLists;
    }

    public void setApprovalInfoLists(List<TrainingCopyModel.ApprovalInfoLists> approvalInfoLists) {
