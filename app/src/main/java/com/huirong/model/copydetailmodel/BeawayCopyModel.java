...
public class BeawayCopyModel implements Serializable {
    ...
    public List<BeawayCopyModel.ApprovalInfoLists> getApprovalInfoLists() {
        return ApprovalInfoLists;
    }

    public void setApprovalInfoLists(List<BeawayCopyModel.ApprovalInfoLists> approvalInfoLists) {
