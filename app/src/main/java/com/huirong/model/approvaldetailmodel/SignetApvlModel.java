...
public class SignetApvlModel implements Serializable {
    ...
    public List<SignetApvlModel.ApprovalInfoLists> ApprovalInfoLists ;
    ...
    public List<SignetApvlModel.ApprovalInfoLists> getApprovalInfoLists() {
        return ApprovalInfoLists;
    }

    public void setApprovalInfoLists(List<SignetApvlModel.ApprovalInfoLists> approvalInfoLists) {
