...
import com.huirong.common.calendarcommon.SpecialCalendar;
...
public class ScheduleMainAdapter extends BaseAdapter {
    ...
    public void getCalendar(int year, int month) {
        ...
        LogUtils.d("ss", isLeapyear + " ======  " + daysOfMonth + "  ============  " + dayOfWeek + "  =========   " + lastDaysOfMonth);
        getweek(year, month);
    }
