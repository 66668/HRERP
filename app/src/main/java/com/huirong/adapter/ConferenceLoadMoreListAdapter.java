...
public class ConferenceLoadMoreListAdapter extends com.huirong.base.BaseLoadMoreListAdapter {
    ...
    public ConferenceLoadMoreListAdapter(Context context, AdapterCallBack callBack) {
        ...
        imgOptions = com.huirong.common.ImageLoadingConfig.generateDisplayImageOptions(R.mipmap.ic_launcher);
    }
    ...
    protected void initViewData(final int position, View convertView) {
        ...
        //获取一条信息
        com.huirong.model.ConferenceMSGModel model = (com.huirong.model.ConferenceMSGModel) entityList.get(position);
