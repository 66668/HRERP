...
public class VehicleMaintainActivity extends BaseActivity {
    ...
    //维修完成时间
    @ViewInject(id = R.id.layout_timeEnd, click = "forEndTime")
    LinearLayout layout_timeEnd;
    @ViewInject(id = R.id.tv_vehicleMainennanceTimeEnd)
    TextView tv_vehicleMainennanceTimeEnd;
    ...
    //行驶公里
    @ViewInject(id = R.id.et_vihicleMiles)
    EditText et_vihicleMiles;
    ...
    private String maintenanceMiles = "";
    ...
    public void forCommit(View view) {
        ...
        maintenanceMiles = et_vihicleMiles.getText().toString().trim();
        ...
        if (TextUtils.isEmpty(maintenanceTimeStart) || TextUtils.isEmpty(maintenanceTimeEnd)) {
     ...
     * @param view
     */
    public void forEndTime(View view) {
        DateChooseWheelViewDialog endDateChooseDialog = new DateChooseWheelViewDialog(VehicleMaintainActivity.this,
                new DateChooseWheelViewDialog.DateChooseInterface() {
                    @Override
                    public void getDateTime(String time, boolean longTimeChecked) {
                        maintenanceTimeEnd = time;
                        tv_vehicleMainennanceTimeEnd.setText(time);
                    }
                });
        //        endDateChooseDialog.setTimePickerGone(true);
        endDateChooseDialog.setDateDialogTitle("维保完成时间");
        endDateChooseDialog.showDateChooseDialog();
    }
