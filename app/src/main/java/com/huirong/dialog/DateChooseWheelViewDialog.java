...
import com.huirong.listener.wheelviewListener.OnWheelChangedListener;
import com.huirong.listener.wheelviewListener.OnWheelScrollListener;
import com.huirong.adapter.AbstractWheelTextAdapter;
import com.huirong.widget.wheelwidget.WheelView;
...
public class DateChooseWheelViewDialog extends Dialog implements View.OnClickListener {
    ...
    private void initView() {
        ...
        Button mSureButton = (Button) view.findViewById(R.id.sure_btn);
        Button mCloseDialog = (Button) view.findViewById(R.id.date_choose_close_btn);
